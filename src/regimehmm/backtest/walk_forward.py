...
def walk_forward_backtest(
    ...
    *,
    ...
    """
    from regimehmm._constants import REBALANCE_PERIODS
    from regimehmm._exceptions import InsufficientDataError, ValidationError
    from regimehmm._validation import ensure_dataframe
    from regimehmm.backtest.costs import FixedBpsCost
    from regimehmm.backtest.stats import turnover as _turnover
